    ...
    private void onBinding() {
        ...
        try {
            ...
            if (binding != null) {
                ...
                binding.setVariable(com.tunasteak.BR.model, tBindingModel);
                binding.setVariable(com.tunasteak.BR.onBarListener, this);
                binding.setVariable(com.tunasteak.BR.data, TBindingData.getInstance());
                binding.setVariable(com.tunasteak.BR.onClickListener, this);
                //
