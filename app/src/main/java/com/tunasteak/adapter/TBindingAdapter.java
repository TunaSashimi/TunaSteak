...
public class TBindingAdapter extends BaseAdapter {
    ...
    public TBindingAdapter(List list, int layoutId, OnItemClickListener onItemClickListener) {
        this.list = list;
        this.itemId = com.tunasteak.BR.bean;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        binding.setVariable(com.tunasteak.BR.position, position);
        binding.setVariable(com.tunasteak.BR.data, TBindingData.getInstance());
        binding.setVariable(com.tunasteak.BR.onClickListener, onClickListener);
        //
